...
const CONFIG = {
  ...
  weapons: [
    ...
    },
    {
      ...
      name: 'Boltgunz',
      icon: '💥',
      description: 'Twin infernal cannons fuse to your arms, blasting explosive shells at the nearest enemy. Each shell detonates on impact, shredding everything in the blast radius.',
      cooldown: 2.0,
      damage: 30,
      projectileSpeed: 8,
      projectileCount: 2,
      ...
      chainRange: 0,
      areaRadius: 62,
      areaDamageMultiplier: 0.7,
      statusEffect: null,
      upgrades: [
        { id: 'boomstick',         name: 'Boomstick',         icon: '💣', description: 'Explosion radius grows 50% and shells deal 30% more damage.',            changes: { areaRadiusMultiplier: 1.5, damageMultiplier: 1.3 } },
        { id: 'incendiary_rounds', name: 'Incendiary Rounds', icon: '🔥', description: 'Each shell scorches the ground on impact, burning enemies who linger.',   changes: { groundEffect: { type: 'burn', duration: 3.0, dps: 8 } } },
        { id: 'drum_mag',          name: 'Drum Magazine',     icon: '🔄', description: 'Fires an extra shell per volley and reloads 25% faster.',                 changes: { projectileCount: 2, cooldownMultiplier: 0.75 } }
      ]
    },
    {
  ...
  monsters: [
    { id: 'goblin',      name: 'Goblin',              icon: '👺', health:  13, speed: 2.10, armor: 0, strength:  4, xp:   3, radius: 12, waveMin:  1, spawnWeight: 10, abilities: ['swarm'] },
    { id: 'skeleton',    name: 'Skeleton',             icon: '💀', health:  19, speed: 1.70, armor: 1, strength:  5, xp:   4, radius: 13, waveMin:  2, spawnWeight:  8, abilities: [] },
  ...
  waveMilestones: [
    ...
    { wave:  2, monstersTotal:  37 },
    { wave:  3, monstersTotal:  42 },
    { wave:  4, monstersTotal:  57 },
    { wave:  5, monstersTotal:  74 },
    { wave:  6, monstersTotal:  90 },
    { wave:  7, monstersTotal:  96 },
    { wave:  8, monstersTotal: 113 },
    { wave:  9, monstersTotal: 133 },
    { wave: 10, monstersTotal: 154, miniBoss: 'troll' },
    { wave: 11, monstersTotal: 172 },
    { wave: 12, monstersTotal: 180 },
    { wave: 13, monstersTotal: 202 },
    { wave: 14, monstersTotal: 308, miniBosses: ['troll'] },
    { wave: 15, monstersTotal: 371, miniBosses: ['troll', 'beholderkin'] },
    { wave: 16, monstersTotal: 436, miniBosses: ['troll', 'troll'] },
    { wave: 17, monstersTotal: 514, miniBosses: ['beholderkin', 'troll', 'beholderkin'] },
    { wave: 18, monstersTotal: 595, miniBosses: ['troll', 'troll', 'beholderkin'] },
    { wave: 19, monstersTotal: 689, miniBosses: ['beholderkin', 'troll', 'troll', 'beholderkin'] },
    { wave: 20, monstersTotal: 798, boss: 'dragon_boss', miniBosses: ['troll', 'troll'] }
  ],
  ...
  combos: [
    ...
    {
      id: 'war_machina', name: 'War Machina', icon: '🔩',
      requires: ['boltgunz', 'viceroy_missile'],
      description: "Shells and missiles blanket the field in synchronized chaos. Boltgunz fires two extra shells per volley. Viceroy Missile fires 4 simultaneously and bounces 3 extra times.",
      weaponBoosts: [
        { weaponId: 'boltgunz',        projectileCount: 4, areaRadiusMultiplier: 1.3 },
        { weaponId: 'viceroy_missile', projectileCount: 3, spreadAngle: 0.35, bounce: 3 }
      ]
    },
    {
      ...
      weaponBoosts: [
        { weaponId: 'boltgunz',   armorPenetration: 6, damageMultiplier: 1.25 },
        { weaponId: 'gravebomb',  gravebombPercentBonus: 0.20, gravebombRadius: 40 }
      ]
    },
  ...
  cycles: {
    ...
    demon:     { name: 'Demon Cycle',     icon: '😈', color: '#ff4466', weapons: ['jakes_lament','babbage_blast','viceroy_missile','stax_black_sauce','alexs_hax','gravebomb','boltgunz'] },
