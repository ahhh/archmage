...
const CONFIG = {
  ...
  weapons: [
    ...
    },
    {
      ...
      name: 'Phoenix Wings',
      icon: '🦅',
      description: 'Fans a wide spread of blazing bolts from both sides of the caster toward the nearest enemy. Bolts accelerate as they fly.',
      cooldown: 1.4,
      damage: 13,
      projectileSpeed: 8,
      ...
      upgrades: [
        ...
        { id: 'wider_wings',      name: 'Wider Wings',      icon: '🦅', description: 'Two additional bolts fan out further to each side.',  changes: { projectileCount: 2, spreadAngle: 0.1 } },
